...
Inference runs inside the Rust core (see `docs/dev/architecture/ARCHITECTURE.md` §11). The `ModelRunner`
...
LiteRT shared library (see `docs/dev/architecture/ARCHITECTURE.md` §11); Kotlin only calls the FFI.
