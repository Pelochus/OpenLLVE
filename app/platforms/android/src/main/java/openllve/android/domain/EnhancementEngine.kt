 ...
 * [ProcessingMetrics]) — it never sees LiteRT/TFLite classes.
 *
 * Current (temporary) implementation: [openllve.android.engine.AndroidLiteRtEngine],
 * which runs the model directly on the LiteRT runtime on Android.
 *
...
interface EnhancementEngine {
     ...
     */
    suspend fun probeBackends(context: Context): BackendProbeResult
     ...
     */
    suspend fun configure(context: Context, settings: EnhancementSettings): BackendSelection
